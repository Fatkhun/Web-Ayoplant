...
<div class="profile-form">
    ...
    <?= $form->field($model, 'job_desc')->textarea(['rows' => 6]) ?>

    <?= $form->field($model, 'fb')->textarea(['rows' => 6]) ?>

    <?= $form->field($model, 'ig')->textarea(['rows' => 6]) ?>

    <?= $form->field($model, 'ln')->textarea(['rows' => 6]) ?>

    <?= $form->field($model, 'url')->textarea(['rows' => 6]) ?>

    <?= $form->field($model, 'public_email')->textarea(['rows' => 6]) ?>
